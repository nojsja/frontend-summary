...
## ➣ React useLayoutEffect 和 useEffect 分析
...
### 三、对于 useEffect 和 useLayoutEffect 哪一个与 componentDidMount，componentDidUpdate 的是等价的？
...
### 四、useEffect 和 useLayoutEffect 哪一个与 componentWillUnmount 的是等价的？
...
### 五、为什么建议将修改 DOM 的操作里放到 useLayoutEffect 里，而不是 useEffect？
